...
from .views import AvailabilitySlotsView, CartListCreateView, CartItemDetailView, BookingCreateView, BookingDetailView, VendorBookingItemStatusView, CustomerBookingItemStatusView
